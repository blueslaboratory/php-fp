...
<?php
     ...
     * http://localhost/workspace-php/003_MyForm/myform3.php
     *
	...
	<!-- 
    este comentario aquí invita a un SQL injection, pero queria decir que hay que poner cosas 
    en el gender para que no te metan un sql injection por aqui:
    -->
  	Gender:

...
<html>
    ...
    <?php
         ...
         * LINUX:
         * file:///var/www/html/003_MyForm/myform5.php
         * http://localhost/003_MyForm/myform5Cookie.php
         * WINDOWS:
		 * F:\Xampp\htdocs\workspace-php\003_MyForm
         * http://localhost/workspace-php/003_MyForm/myform5Cookie.php
         *
         *
    ...
    <h2>PHP Form Validation Example</h2>
    	...
    	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    		...
    		<a href="myform6Cookie.php" target="blank">Comprobando cookies y sesion</a>
